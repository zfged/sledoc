...
<div id="content"><?php echo $content_top; ?>
	...
	<?php if ($products) { ?>
		<div class="product-filter">
			<div class="display"><span class="displaytext"><?php echo $text_display; ?></span>
				<div class="listviewactive"><span class="listtext"><?php echo $text_list; ?></span></div><a onclick="display(\'grid\');">
					<div class="gridview"><span class="gridtext"><?php echo $text_grid; ?></span></div>
				</a>
			</div>
