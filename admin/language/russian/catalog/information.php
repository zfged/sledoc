...
$_['entry_bottom']            = 'Bottom:<br/><span class="help"> Отображать в нижней части сайта.</span>';
...
$_['error_account']     	  = 'Эта статья не может быть удалена, поскольку она назначена Политикой безопасности по-умолчанию!';
$_['error_checkout']    	  = 'Эта статья не может быть удалена, поскольку она назначена Условиями соглашения по-умолчанию!';
