...
class ControllerCatalogFilter extends Controller {
    ...
    $this->data['options'] = array();
		...
		$this->data['column_filter_groups'] = $this->language->get('column_filter_groups');
		$this->data['column_sort_order'] = $this->language->get('column_sort_order');
	...
	private function getForm() {
		...
		$this->data['text_select_all'] = $this->language->get('text_select_all');
		$this->data['entry_filter_groups'] = $this->language->get('entry_filter_groups');
    ...
    if (isset($this->request->post['types'])) {
      ...
      $this->data['option_types'] = $this->model_catalog_filter->getOptionTypes($this->request->get['option_id']);
    } else {
    ...
    if (isset($this->request->post['styles'])) {
      ...
      $this->data['option_styles'] = $this->model_catalog_filter->getOptionStyles($this->request->get['option_id']);
    } else {
	...
	if (isset($this->request->post['option_filter_group'])) {
      $this->data['option_filter_group'] = $this->request->post['option_filter_group'];
    } elseif (isset($option_info)) {
      $this->data['option_filter_group'] = $this->model_catalog_filter->getOptionFilterGroups($this->request->get['option_id']);
    } else {
      $this->data['option_filter_group'] = array();
    }
	...
	private function getTypeName($index)
	{
	 ...
	 private function getTypes()
	 {
		...
		$typesOptions['options'] = $this->model_catalog_filter->getOptionsForTypes();
		$types =  array_merge_recursive($types, $typesOptions);
		
		$typesAttributes['attributes'] = array();
		$typesAttributes['attributes'] = $this->model_catalog_filter->getAttributesForTypes();
